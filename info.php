                            ...
                            <table cellpadding="0" cellspacing="0" width="100%" class="table">
                                ...
                                <?php foreach($override->get('computer_request','staff_id', $user->data()->id) as $request){?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" role="button" class="btn <?php if($request['specs_status']==1){echo 'btn btn-success';}else{echo 'btn btn-warning';}?> ">Specs</a>
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%" class="table">
                                ...
                                <?php foreach($override->get('computer_request','staff_id', $user->data()->id) as $request){?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#view<?=$request['id']?>" role="button" class="btn btn-info" data-toggle="modal">Add Specs</a>
